...
LIST_QC = []
LIST_XUPHAT = []
with open('TK_C3.txt', 'r') as f1 :
    LIST_CQ_C3 = f1.read()
with open('TK_tungho.txt', 'r') as f2 :
    LIST_CQ_TH = f2.read() 
with open('TK_tungho.txt', 'r') as f3 :
    LIST_CQ_Z = f3.read()
with open('TK_tungho.txt', 'r') as f4 :
    LIST_CQ_Q = f4.read()
with open('TK_tungho.txt', 'r') as f5 :
    LIST_CQ_C2 = f5.read()
...
class Main(QtWidgets.QMainWindow,Ui_MainWindow):
    ...
    def taonhomtha(self):
        ...
        a.setText(x)
    def taonhomnap(self):
        x=" nạp chơi để có đơn cược xác định sẽ được cấp tài khoản DIỄN ĐÀN GIẢI MÃ SỐ HỌC MIỄN PHÍ."        
        self.textEdit.setText(x)
        a = QtWidgets.QApplication.clipboard()
        a.setText(x)
    def timlaimk(self):
...
class Threading(QtCore.QThread):
    ...
    def __init__(self):
        ...
        self.sheets = ['THÁNG 12','2020-2019','2021','TK QC Tự cấp','XỬ PHẠT']
    ...
    def run(self):
        ...
        self.msg.emit('Đã nạp xong dữ liệu')
